...
public class RoadParser {
    ...
    public String toGeoJSON(String nomRN, List<Point> points) {
        StringBuilder sb = new StringBuilder();

        sb.append("{ \"type\": \"Feature\", ");
        sb.append("\"properties\": { \"name\": \"" + nomRN + "\" }, ");
        sb.append("\"geometry\": { \"type\": \"LineString\", \"coordinates\": [");

        for (Point p : points) {
            sb.append("[" + p.lon + "," + p.lat + "],");
        }
    ...
    public static void generateGeoJSONFile(String outputPath) throws IOException {
        // TODO: Utiliser le nouveau système LoadSampleRN
